...
#![warn(clippy::all)]
//! Test SQL syntax, which all parser dialects must parse in the same way.
//!
...
//! parser regardless of the chosen dialect (i.e. it doesn't conflict with
...
use parser::keywords::ALL_KEYWORDS;
...
fn parse_start_transaction() {
    ...
    // Regression test for https://github.com/parser/parser/pull/139,
